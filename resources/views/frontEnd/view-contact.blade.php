        ...
        <div class="row">
            <div class="col-12">
                <div class="contact-form headstyle pt_90">
                    <h4>{{ CONTACT_FORM }}</h4>
                    <form method="POST" action="{{ route('contact.send.email') }}" class="form_contact_ajax">
                        @csrf
                        ...
                        <div class="form-row row">
                            ...
                            @endif
                            <div class="form-group col-12">
                                <button type="submit" class="btn" name="form_contact">{{ SEND_MESSAGE }}</button>
                            </div>
                        </div>
                    </form>
                </div>
...
<!--Map Start-->
<div class="map-area">{!! $page_contact->contact_map !!}
