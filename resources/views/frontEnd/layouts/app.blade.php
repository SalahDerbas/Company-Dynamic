                ...
                <div class="col-lg-9 col-12 main-menu">
                    <div class="main-menu-item">
                        <ul class="nav-menu">
                            ...
                            @endif
                            <li><a target="_blank" href="https://fncs-jo.com/public/upload/Company Profile FNCScomm.pdf">Company Profile</a></li>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6" hidden>
                    <div class="footer-item" id="newsletter">
                        ...
                        <p>
                            {{ $footer_setting->newsletter_text }}
                        </p>
                ...
                <div class="col-lg-4 col-md-6"><b>
                    <div class="footer-item">
                        <h3>Recent Project</h3>
                        <div class="row pl-10 pr-10">
                            <li><a target="_blank" href="https://fncs-jo.com/public/upload/Company Profile FNCScomm.pdf">Download Our Company Profile</a></li>
                        </div><br>
                        <div class="row pl-10 pr-10">
                            <li><a  href="{{ route('home.portfolio')}}">Explore Our {{ PORTFOLIO }}</a></li>
                        </div><br>
                        <div class="footer-address-item">
                            <div class="icon">@if($footer_setting->footer_email)<i class="fas fa-envelope"></i>@endif</div>
                            <div class="text">
                                <span>
                                    {{ $footer_setting->footer_email }}
                                </span>
                            </div>
                        </div>                    </div>
                 </b></div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    @endif
                    <div class="copy-text">
                        <p><a href="https://potato-co.com" target="_blank" style="color:#2dbccc">
