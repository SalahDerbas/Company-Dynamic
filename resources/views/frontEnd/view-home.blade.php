                    ...
                    <div class="row">
                        <div class="@if($slider->position == 'Left') {{'col-lg-6 col-md-9 col-12'}} @else {{'offset-lg-6 col-lg-6 offset-md-3 col-md-9 col-12'}} @endif">
                            <div class="slider-text">
                                ...
                                <div class="text-animated" hidden>
                                    <ul>                                        
        ...
        <div class="row">
            <div class="col-lg-6 mt_30">
                <div class="about-content">
                    ...
                    <p>
                    	{!! clean($page_home->home_welcome_text) !!}
                    </p>
...
<div hidden class="testimonial-area pt_90 pb_90" style="background-image: url({{ asset('upload/'.$page_home_lang_independent->home_testimonial_photo) }})">
...
<div class="blog-area pt_90 pb_90" hidden>
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="headline">
...
<!--Brand-Area Start-->
<div class="brand-area bg-area pt_20 pb_20">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="brand-carousel owl-carousel">
                    @foreach($clients as $data)
                        @if($data->url != '')
                            <div class="brand-item" style="height:120px;"><a href="{{ $data->url }}"><img style="height:100%; src="{{ asset('upload/'.$data->photo) }}" alt="{{ $data->name }}"></a></div>
                        @else
                            <div class="brand-item" style="height:120px;" ><img style="height:100%;" src="{{ asset('upload/'.$data->photo) }}" alt="{{ $data->name }}" ></div>
                        @endif
                    @endforeach
                </div>
            </div>
